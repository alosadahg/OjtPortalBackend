...
namespace OjtPortal.Infrastructure
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<TrainingPlan, UpdateTrainingPlanDto>().ReverseMap();
            ...
            CreateMap<TrainingTask, UpdateTaskDto>().ReverseMap();
            ...
            CreateMap<SubMentor, SubMentorWithTasksDto>().ReverseMap();
        }
    }
}
